  ...
  return (
    <div className={styles.section} id='ourApproach'>
      ...
      <div className={styles.container} id='specials'>
        <ApproachCart imgURL={bartender} altMsg={'Bartender making cocktail'} headline={'Staffing Distinction:'} text={'Imagine a reservoir of unparalleled talent, handpicked to meet the unique demands of your establishment. From skilled culinary artisans to captivating front-of-house professionals, our candidates embody the essence of exceptional guest experiences. '}/>
        <ApproachCart imgURL={chef} altMsg={'Chef chopping'} headline={'Our Profound Expertise:'} text={'Within the halls of Vipers London, a collective of industry experts converge, each with an intricate understanding of the nuances within the hospitality sector. We seamlessly blend our extensive experience with a dedication to perfection, presenting an array of bespoke staffing talents and incisive consultancy prowess that defies convention. '}/>
        <ApproachCart imgURL={wedding} altMsg={'Setting up the table'} headline={'Elevated Consultancy: '} text={'Elevate your venture through our comprehensive consultancy services, an avant-garde approach to refining your hospitality enterprise. Our adept consultants meticulously analyze every facet of your business, offering insights and strategies that enhance efficiency, amplify guest satisfaction, and catalyze profitability.'}/>
